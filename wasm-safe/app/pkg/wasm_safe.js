...
* @returns {boolean}
*/
export function verify_part_one() {
    const ret = wasm.verify_part_one();
    return ret !== 0;
}
...
* @returns {boolean}
*/
export function verify_part_three() {
    const ret = wasm.verify_part_three();
    return ret !== 0;
}
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('wasm_safe_bg.wasm', import.meta.url);
    }
    const imports = getImports();
